...
class OverlayShowingService extends Service implements OnTouchListener, OnClickListener {
    ...
    private void takeScreenshot() {
        ...
        //If Screenshot type is FULL take full page screenshot i.e our root content.
            b = com.example.summers.overlay.ScreenshotUtils.getScreenShot(topLeftView);
        //break;
        //case CUSTOM:
        ...
        //If bitmap is not null
            ...
            //showScreenShotImage(b);//show bitmap over imageview
              ...
              File saveFile = com.example.summers.overlay.ScreenshotUtils.getMainDirectoryName(this);//get the path to save screenshot
              File file = com.example.summers.overlay.ScreenshotUtils.store(b, "screenshot"  + ".jpg", saveFile);//save the screenshot to selected path
